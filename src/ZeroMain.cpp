// PROJECT ZERO - Standalone Window Application
// Simple black window with ImGui menu
// NOT an overlay - just a normal windowed application
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    while (running)
    {
        ...
        // Render radar in a separate window
        RenderRadarOverlay();
